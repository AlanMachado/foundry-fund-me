...
contract MockV3Aggregator is AggregatorV3Interface {
    ...
    function getRoundData(uint80 _roundId) external view returns(uint80 roundId, int256 answer, uint256 answer, uint256 startedAt, uint256 updatedAt, uin80 answeredInRound) {
